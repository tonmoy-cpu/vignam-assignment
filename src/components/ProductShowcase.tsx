  ...
  const products = [
    {
      ...
      image:
        "https://i.pinimg.com/736x/24/06/01/240601839f80a88fb57fb9ae1956b915.jpg",
    },
    {
      name: "Mounting Plate",
      ...
      image:
        "https://media.printables.com/media/prints/204147/images/1877670_6314cde1-d470-4db0-9210-4625c36f1635/thumbs/inside/1280x960/jpg/1fbb4bae1db1fbc5faa104c6f6733b3c_display_large_20.webp",
    },
    {
      ...
      image:
        "https://d1ds8nu9vo9fn9.cloudfront.net/blog-images/formbox-vacuum-forming-3D-printing-3D-printed-electronic-component-tray.jpg",
    },
    {
      name: "Protective Cap",
      ...
      image:
        "https://fbi.cults3d.com/uploaders/16984740/illustration-file/8ff9ec1c-1be7-4e52-8b89-9601ef52e51d/d0064d7cd4e58864d2baa0d97c66e90d.png",
    },
  ];
  ...
  return (
    <section id="products" className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-1 relative z-10">
        ...
        {/* Mobile layout: stack cards normally */}
          ...
          <AnimatePresence mode="wait">
            {visibleProducts.map((product, cardIndex) => (
              <motion.div
                ...
                className="absolute w-[calc(33.333%-1rem)] bg-white rounded-lg border border-gray-200 p-6 shadow-sm"
                style={{
                  left:
                    cardIndex === 0
                      ? "0%"
